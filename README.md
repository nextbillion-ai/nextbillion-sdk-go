...
[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=%40nbai%2Fsdk-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIkBuYmFpL3Nkay1tY3AiXX0)
...
```sh
go get -u 'github.com/nextbillion-ai/nextbillion-sdk-go@v0.1.0-alpha.20'
```
