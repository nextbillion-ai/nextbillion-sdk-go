...
type AutocompleteSuggestResponse struct {
	...
	Items []AutocompleteSuggestResponseItem `json:"items"`
...
func (r AutocompleteSuggestResponse) RawJSON() string { return r.JSON.raw }
func (r *AutocompleteSuggestResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AutocompleteSuggestResponseItem struct {
	...
	OpeningHours AutocompleteSuggestResponseItemOpeningHours `json:"openingHours"`
	// Returns the location coordinates of the result.
	Position Position `json:"position"`
	// Score of the result. A higher score indicates a closer match.
	Scoring AutocompleteSuggestResponseItemScoring `json:"scoring"`
...
// Returns the unmodified JSON received from the API
func (r AutocompleteSuggestResponseItem) RawJSON() string { return r.JSON.raw }
func (r *AutocompleteSuggestResponseItem) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Returns the operating hours of the place, if available.
type AutocompleteSuggestResponseItemOpeningHours struct {
	// A collection of attributes with details about the opening and closing hours for
	// each day of the week.
	TimeRanges []AutocompleteSuggestResponseItemOpeningHoursTimeRange `json:"timeRanges"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
// Returns the unmodified JSON received from the API
func (r AutocompleteSuggestResponseItemOpeningHours) RawJSON() string { return r.JSON.raw }
func (r *AutocompleteSuggestResponseItemOpeningHours) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AutocompleteSuggestResponseItemOpeningHoursTimeRange struct {
	// Returns the closing time details.
	EndTime AutocompleteSuggestResponseItemOpeningHoursTimeRangeEndTime `json:"endTime"`
	// Returns the open time details.
	StartTime AutocompleteSuggestResponseItemOpeningHoursTimeRangeStartTime `json:"startTime"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
...
// Returns the unmodified JSON received from the API
func (r AutocompleteSuggestResponseItemOpeningHoursTimeRange) RawJSON() string { return r.JSON.raw }
func (r *AutocompleteSuggestResponseItemOpeningHoursTimeRange) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Returns the closing time details.
type AutocompleteSuggestResponseItemOpeningHoursTimeRangeEndTime struct {
...
// Returns the open time details.
type AutocompleteSuggestResponseItemOpeningHoursTimeRangeStartTime struct {
...
// Score of the result. A higher score indicates a closer match.
type AutocompleteSuggestResponseItemScoring struct {
...
// Returns the unmodified JSON received from the API
func (r AutocompleteSuggestResponseItemScoring) RawJSON() string { return r.JSON.raw }
...
// URLQuery serializes [AutocompleteSuggestParams]'s query parameters as
// `url.Values`.
